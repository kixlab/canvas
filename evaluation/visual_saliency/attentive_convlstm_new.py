...
class AttentiveConvLSTM2DCell(Layer):
    def __init__(
        ...
        **kwargs
        ...
        self.attentive_kernel_size = conv_utils.normalize_tuple(
            attentive_kernel_size, 2, "attentive_kernel_size"
        )
        ...
        self.attentive_dropout = min(1.0, max(0.0, attentive_dropout))
    ...
    def build(self, input_shape):
        ...
        input_attentive_kernel_shape = self.attentive_kernel_size + (
            input_dim,
            self.attentive_filters,
        )
        hidden_attentive_kernel_shape = self.attentive_kernel_size + (
            self.filters,
            self.attentive_filters,
        )
        squeeze_attentive_kernel_shape = self.attentive_kernel_size + (
            self.attentive_filters,
            1,
        )
        ...
        if self.use_bias:
            ...
            self.bias_ua = self.attentive_bias[
                self.attentive_filters : self.attentive_filters * 2
            ]
        else:
            self.bias_i = None
            self.bias_f = None
    ...
    def call(self, inputs, states, training=None):
        ...
        h_and_x = self.input_conv(
            h_tm1, self.hidden_attentive_kernel, self.bias_ua, padding="same"
        ) + self.input_conv(
            inputs, self.input_attentive_kernel, self.bias_wa, padding="same"
        )

        e = self.recurrent_conv(
            self.attentive_activation(h_and_x), self.squeeze_attentive_kernel
        )
    ...
    def get_config(self):
        config = {
            ...
            "attentive_activation": activations.serialize(self.attentive_activation),
            "use_bias": self.use_bias,
            "kernel_initializer": initializers.serialize(self.kernel_initializer),
            "recurrent_initializer": initializers.serialize(self.recurrent_initializer),
            "attentive_initializer": initializers.serialize(self.attentive_initializer),
            "bias_initializer": initializers.serialize(self.bias_initializer),
            "unit_forget_bias": self.unit_forget_bias,
            "kernel_regularizer": regularizers.serialize(self.kernel_regularizer),
            "recurrent_regularizer": regularizers.serialize(self.recurrent_regularizer),
            "attentive_regularizer": regularizers.serialize(self.attentive_regularizer),
            "bias_regularizer": regularizers.serialize(self.bias_regularizer),
            "kernel_constraint": constraints.serialize(self.kernel_constraint),
            "recurrent_constraint": constraints.serialize(self.recurrent_constraint),
            "attentive_constraint": constraints.serialize(self.attentive_constraint),
...
class AttentiveConvLSTM2D(ConvRNN2D):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AttentiveConvLSTM2D, self).__init__(
            cell,
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        print("----")
        return super(AttentiveConvLSTM2D, self).call(
